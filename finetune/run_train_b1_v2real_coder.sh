#!/bin/bash
# Retrain Coder-B1 on TRUE v2 data
set -e
PYTHON=/data1/env/envs/graphenhanced/bin/python3
DATA=dataset/finetune_data_v2
RUNS=runs
MODEL=/data1/models/Qwen2.5-Coder-3B-Instruct
SEED=42
GPU=7

OUT=$RUNS/v2real_qwen25coder_b1_train_a_seed${SEED}
# Coder is non-VLM Qwen2.5; just use standard attention projs
TARGETS="q_proj k_proj v_proj o_proj"

echo "=========================================="
echo "[$(date '+%F %T')] Coder-B1 retrain on TRUE v2 data"
...
echo "[$(date '+%F %T')] Coder-B1 v2real done → $OUT"
